const FAILURE_CODES = Object.freeze({
  ...
  HTML_ACCESS_DENIED: "HTML_ACCESS_DENIED",
  HTML_EMPTY_CONTENT: "HTML_EMPTY_CONTENT",
  HTML_DYNAMIC_CONTENT_UNAVAILABLE: "HTML_DYNAMIC_CONTENT_UNAVAILABLE",
  HTML_EXTRACTION_LOW_QUALITY: "HTML_EXTRACTION_LOW_QUALITY",
  HTML_UNSUPPORTED_STRUCTURE: "HTML_UNSUPPORTED_STRUCTURE",
  HTML_REDIRECT_INVALID: "HTML_REDIRECT_INVALID",
  HTML_CONTENT_TYPE_MISMATCH: "HTML_CONTENT_TYPE_MISMATCH",
...
const PERMANENT_CODES = new Set([
  ...
  FAILURE_CODES.HTML_ACCESS_DENIED,
  FAILURE_CODES.HTML_EMPTY_CONTENT,
  FAILURE_CODES.HTML_EXTRACTION_LOW_QUALITY,
  FAILURE_CODES.HTML_UNSUPPORTED_STRUCTURE,
  FAILURE_CODES.HTML_REDIRECT_INVALID,
...
const STAGE_BY_CODE = Object.freeze({
  ...
  [FAILURE_CODES.HTML_FETCH_FAILED]: "download",
  [FAILURE_CODES.HTML_ACCESS_DENIED]: "download",
  [FAILURE_CODES.HTML_EMPTY_CONTENT]: "extraction",
  [FAILURE_CODES.HTML_DYNAMIC_CONTENT_UNAVAILABLE]: "extraction",
  [FAILURE_CODES.HTML_EXTRACTION_LOW_QUALITY]: "extraction",
  [FAILURE_CODES.HTML_UNSUPPORTED_STRUCTURE]: "extraction",
  [FAILURE_CODES.HTML_REDIRECT_INVALID]: "download",
  [FAILURE_CODES.HTML_CONTENT_TYPE_MISMATCH]: "download",
