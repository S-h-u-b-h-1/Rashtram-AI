...
const policyDraftRouter = require("./policy/draftRoute");
const productIntelligenceRouter = require("./product/route");
...
app.use("/api/policy-drafts", fetchUser, policyDraftRouter);
app.use("/api/product-intelligence", fetchUser, productIntelligenceRouter);
