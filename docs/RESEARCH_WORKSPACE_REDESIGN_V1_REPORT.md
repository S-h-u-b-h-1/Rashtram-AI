...
## Final main integration — 5 September 2026

The final integration branch was created from main `94df6e7` (latest committed Release D state), which includes Release C commits `bf2b8be`, `23e7dd2` and `1bd253b`. The prior redesign source was `codex/research-workspace-redesign-v1` at `728d236`.
...
19. **User-study document:** [docs/RESEARCH_WORKSPACE_V1_USER_STUDY.md](/Users/shubhaang/Desktop/RashtramAI/docs/RESEARCH_WORKSPACE_V1_USER_STUDY.md).
