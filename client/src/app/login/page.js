        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              disabled={loading}
              required
              className="h-12 w-full rounded-xl border border-[#19231f]/12 bg-white px-4 text-sm text-[#19231f] placeholder:text-[#9c9589] transition focus:border-[#d97745] focus:outline-none focus:ring-4 focus:ring-[#d97745]/10 disabled:opacity-60"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                disabled={loading}
                required
                className="h-12 w-full rounded-xl border border-[#19231f]/12 bg-white px-4 pr-12 text-sm text-[#19231f] placeholder:text-[#9c9589] transition focus:border-[#d97745] focus:outline-none focus:ring-4 focus:ring-[#d97745]/10 disabled:opacity-60"
              />
              <button
                type="button"
                onClick={() => setShowPassword((visible) => !visible)}
                className="absolute inset-y-0 right-0 grid w-12 place-items-center text-[#7e776d] hover:text-[#19231f]"
