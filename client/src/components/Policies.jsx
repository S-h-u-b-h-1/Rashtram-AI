...
export default function Policies() {
  return (
    <DocumentExplorer
      ...
      dataNote="Coverage contains official public records currently available through connected sources. Source health and PDF availability are shown without estimates."
    />
  );
}
