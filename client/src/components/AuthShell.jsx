...
export function AuthShell({ eyebrow, title, description, children }) {
  return (
    <main className="min-h-screen bg-[#f4efe5] lg:grid lg:grid-cols-[0.9fr_1.1fr]">
      <section className="relative hidden min-h-screen overflow-hidden bg-[#19231f] p-10 text-white lg:flex lg:flex-col xl:p-14">
      ...
      <section className="relative flex min-h-screen items-center justify-center px-5 py-8 sm:px-8 lg:px-12">
        <Link
          href="/"
          className="absolute left-5 top-5 inline-flex items-center gap-2 rounded-full px-3 py-2 text-sm text-[#5f5a52] transition hover:bg-white/60 hover:text-[#19231f] sm:left-8 sm:top-7"
        >
        ...
        <div className="w-full max-w-[470px]">
          ...
          <h1 className="mt-3 font-serif text-4xl tracking-[-0.03em] text-[#19231f] sm:text-5xl">
            {title}
          </h1>
