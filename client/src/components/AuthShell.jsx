...
export function AuthShell({ eyebrow, title, description, children }) {
  return (
    <main className="min-h-svh w-full overflow-x-clip bg-[#f0ebe3] lg:grid lg:grid-cols-[0.9fr_1.1fr]">
      <section className="relative hidden min-h-svh overflow-hidden bg-[#8f1d2c] p-10 text-white lg:flex lg:flex-col xl:p-14">
