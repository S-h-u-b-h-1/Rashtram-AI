    ...
    >
      <div className="border-b border-[#8f1d2c]/8 bg-[#f6f2eb] p-5">
        <div className="flex items-start justify-between gap-3">
          ...
          <span className="inline-flex items-center gap-1 rounded-full bg-[#e8f0eb] px-2.5 py-1 text-xs font-semibold text-[#34725b]">
          ...
          return (
            <div key={item.label} className="flex items-center gap-3 py-3">
              ...
              <div className="min-w-0">
                <dt className="text-xs uppercase tracking-[0.1em] text-[#91887d]">
                  {item.label}
                </dt>
      ...
      <div className="grid gap-2 border-t border-[#8f1d2c]/8 p-4 sm:grid-cols-2 xl:grid-cols-1 2xl:grid-cols-2">
        <button
          ...
          className="inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-[#8f1d2c] px-3 text-xs font-semibold text-white"
        >
        ...
        <button
          ...
          className="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-[#8f1d2c]/10 bg-white px-3 text-xs font-semibold text-[#8f1d2c]"
        >
          Security
